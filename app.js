// === Linear Algebra - Core Application ===
...
const App = {
    ...
    // --- Progress ---
    loadProgress() {
        try { this.progress = JSON.parse(localStorage.getItem('linear-algebra-progress') || '{}'); }
        catch (e) { this.progress = {}; }
    },
    saveProgress() {
        try { localStorage.setItem('linear-algebra-progress', JSON.stringify(this.progress)); } catch (e) {}
    },
